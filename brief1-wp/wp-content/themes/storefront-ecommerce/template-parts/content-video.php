  ...
  <?php if( get_theme_mod('storefront_ecommerce_metafields_date', true) != '' || get_theme_mod('storefront_ecommerce_metafields_author', true) != '' || get_theme_mod('storefront_ecommerce_metafields_comment', true) != '' || get_theme_mod('storefront_ecommerce_metafields_time', true) != '' &&  get_theme_mod('storefront_ecommerce_display_post_date', true) != '' || get_theme_mod('storefront_ecommerce_display_post_author', true) != '' || get_theme_mod('storefront_ecommerce_display_post_comment', true) != '' || get_theme_mod('storefront_ecommerce_display_post_time', true) != ''){ ?>
      <div class="metabox p-2 mb-3">
        <?php if( get_theme_mod( 'storefront_ecommerce_metafields_date',true) != '' || get_theme_mod( 'storefront_ecommerce_display_post_date',true) != '') { ?>
          <span class="entry-date me-2"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_post_date_icon','far fa-calendar-alt')); ?> me-1"></i> <a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('storefront_ecommerce_blog_post_meta_seperator') ); ?>
        <?php }?>
        ...
        <?php if( get_theme_mod( 'storefront_ecommerce_metafields_comment',true) != '' || get_theme_mod( 'storefront_ecommerce_display_post_comment',true) != '') { ?>
          <span class="entry-comments me-2"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_post_comment_icon','fas fa-comments')); ?> me-1"></i> <?php comments_number( __('0 Comment', 'storefront-ecommerce'), __('0 Comments', 'storefront-ecommerce'), __('% Comments', 'storefront-ecommerce') ); ?></span>
        <?php }?>
        <?php if( get_theme_mod( 'storefront_ecommerce_metafields_time',false) != '' || get_theme_mod( 'storefront_ecommerce_display_post_time',false) != '') { ?>
          <span class="entry-time me-2"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_post_time_icon','fas fa-clock')); ?> me-1"></i> <?php echo esc_html( get_the_time() ); ?></span>
        <?php }?>
      </div>
    <?php }?>
  <div class="box-image">
