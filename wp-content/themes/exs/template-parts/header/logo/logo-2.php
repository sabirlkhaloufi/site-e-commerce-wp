...
?>
<a<?php if ( is_customize_preview() ) : ?> id="logo"<?php endif; ?> class="logo logo-vertical <?php echo esc_attr( $exs_logo_image_class . ' ' . $exs_logo_background . ' ' . $exs_logo_padding_class . ' ' . $exs_logo_width_class ); ?>" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" itemprop="url">
	<?php
	//image
	...
	//text
	if ( ! empty( $exs_logo_text_primary ) || ! empty( $exs_logo_text_secondary ) ) :
		?>
		<span class="logo-text">
			...
			<?php endif; ?>
			<?php if ( ! empty( $exs_logo_text_secondary ) ) : ?>
