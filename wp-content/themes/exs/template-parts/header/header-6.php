...
<div id="header-affix-wrap" class="header-wrap <?php echo esc_attr( $exs_header_background . ' ' . $exs_transparent . ' ' . $exs_absolute ); ?>">
	...
	<header
		...
		class="header header-6 no-logo <?php echo esc_attr( $exs_header_background . ' ' . $exs_header_align_main_menu . ' ' . $exs_font_size . ' ' . $exs_sticky . ' ' . $exs_transparent . ' ' . $exs_absolute . ' ' . $exs_toggler_main_center ); ?>">
		<?php
...
<div id="toplogo" class="toplogo <?php echo esc_attr( $exs_font_size . ' ' . $exs_header_toplogo_bg . ' ' . $exs_header_top_tall . ' ' . $exs_toplogo_hidden_class ); ?>">
	<div class="container<?php echo esc_attr( $exs_fluid ); ?>">
		<div class="cols-3">
			<div class="meta-wrap">
				<div class="<?php echo esc_attr( $exs_meta_hidden_class ); ?>">
				<?php
				if ( ! empty( $exs_phone ) ) :
					?>
					<div>
