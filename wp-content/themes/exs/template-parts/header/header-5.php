...
if ( $exs_transparent && ! exs_hex_is_light( $header_bg_hex ) )  {
	...
	$exs_header_toplogo_bg = $exs_header_orig_bg;
	$exs_header_orig_bg    = '';
}
...
<div id="header-affix-wrap" class="header-wrap <?php echo esc_attr( $exs_header_background . ' ' . $exs_transparent . ' ' . $exs_absolute ); ?>">
	...
	<header
		...
		class="header header-5 no-logo <?php echo esc_attr( $exs_header_background . ' ' . $exs_header_align_main_menu . ' ' . $exs_font_size . ' ' . $exs_sticky . ' ' . $exs_transparent . ' ' . $exs_absolute . ' ' . $exs_toggler_main_center ); ?>">
		<?php
