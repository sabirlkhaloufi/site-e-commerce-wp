...
<article>
	...
	if ( is_singular( 'attachment' ) ) {
		...
		the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'ultimate-ecommerce-shop' ) . '</span> ' .
				'<span class="screen-reader-text">' . __( 'Next post:', 'ultimate-ecommerce-shop' ) . '</span> ',
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'ultimate-ecommerce-shop' ) . '</span> ' .
